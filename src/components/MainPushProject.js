...
function MainPushProject() {
    ...
    const getTime = () => {
      ...
      const fetchNewData = () =>
      {
        fetch(`api/api/get_pushProject/${idProject}/${userId}`)
          .then((response) => {
            if (!response.ok) {
    ...
    useEffect(() => {
        fetch(`/api/get_porject/${selectedOptionKey}`)
          .then((response) => {
            if (!response.ok) {
              throw new Error("Network response was not ok");
            }
      ...
      useEffect(() => {
        fetch(`/api/get_pushProject/${idProject}/${userId}`)
          .then((response) => {
            if (!response.ok) {
              throw new Error("Network response was not ok");
            }
      ...
      useEffect(() => {
        fetch(`/api/get_idTeacher/${userId}`)
          .then((response) => {
            if (!response.ok) {
              throw new Error("Network response was not ok");
            }
